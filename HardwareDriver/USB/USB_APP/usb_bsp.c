...
#define USB_HOST_PWRCTRL 	PDout(10)				//USB主机电源控制口PD10
...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
	...
	RCC_AHB2PeriphClockCmd(RCC_AHB2Periph_OTG_FS, ENABLE);				//使能USB OTG时钟钟
	//GPIOA11,A12设置
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;							//PA8推挽输出		
